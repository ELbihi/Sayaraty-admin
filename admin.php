                  ...
                  <div class="card_body">
                    <div class="table_res">
                        <table width="100%">
                            ...
                            $requete = mysqli_query( $connexion , "SELECT Nom,Prix_payer,Statut FROM candidat where id_candidat=1 or id_candidat=0");
              ...
              <div class="card_body">
                <div class="table_res">
                    <table width="100%">
                        ...
                        $requete = mysqli_query($connexion , "SELECT Nom,num_CIN_moniteur,num_licence FROM moniteur where Id_moniteur=1 or Id_moniteur=0");
      ...
      <div class="card_body">
        <div class="table_res">
            <table width="100%">
                ...
                $requete = mysqli_query($connexion , "SELECT Nom , Email, Objet, Contenu FROM  Message where ID_message=1 or ID_message=0");
...
<div class="custmer">
      ...
      <script>
      let nu = document.getElementsById("Submenu");
      function togglle(){
          
          nu.classList.toggle("open-m");
      }
